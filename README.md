...
## Эксперимент 3: сегментация зданий на спутниковых снимках (DeepLabV3)

Ноутбук: 3. Buildings_UNet_(trees).ipynb

### Изменения относительно прошлого ноутбука (U-Net + ResNet50 encoder) Новая аугментация: имитация окклюзий “кронами деревьев”
